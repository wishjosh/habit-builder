...
export function avatar(type,cls='') {
  ...
  const head=(color)=>`<ellipse cx="28" cy="32" rx="23" ry="21" fill="${color}"/>`;
  const ears=(color)=>`<circle cx="10" cy="16" r="9" fill="${color}"/><circle cx="46" cy="16" r="9" fill="${color}"/>`;
  Object.assign(faces,{
    rat:ears('#b3bdce')+'<circle cx="10" cy="16" r="5" fill="#efc2c3"/><circle cx="46" cy="16" r="5" fill="#efc2c3"/>'+head('#d5deea')+'<path d="m4 36 10 2m-9 5 10-2m26-3 10-2m-10 5 10 2" stroke="#8796ad" stroke-width="2"/><circle cx="28" cy="36" r="3" fill="#b17a8c"/>',
    ox:'<path d="M14 20Q1 18 5 4L19 15M42 20Q55 18 51 4L37 15" fill="#c4ae76"/>'+ears('#b98f68')+head('#e6c498')+'<ellipse cx="28" cy="41" rx="13" ry="10" fill="#f4ddbd"/><circle cx="23" cy="37" r="2" fill="#927658"/><circle cx="33" cy="37" r="2" fill="#927658"/>',
    tiger:ears('#d88d3f')+head('#f1b965')+'<ellipse cx="28" cy="40" rx="12" ry="10" fill="#fff0cd"/><path d="m22 13 3 9m9-9-3 9M7 24l8 4M6 33l8 1m35-10-8 4m9 5-8 1" stroke="#795839" stroke-width="3" stroke-linecap="round"/>',
    dragon:'<path d="m12 21-2-16 11 9m23 7 2-16-11 9" fill="#ceb580"/><path d="m7 23-6 5 7 8m41-13 6 5-7 8" fill="#87ac92"/>'+head('#aed0b1')+'<path d="m21 15 7-12 7 12" fill="#7aa88b"/><ellipse cx="28" cy="41" rx="14" ry="10" fill="#d7e6b9"/><circle cx="23" cy="37" r="2" fill="#6e8e68"/><circle cx="33" cy="37" r="2" fill="#6e8e68"/>',
    snake:'<path d="M12 43C-1 20 6 6 28 6s29 14 16 37Q28 57 12 43" fill="#b4c78b"/><ellipse cx="28" cy="39" rx="17" ry="13" fill="#e5e9bd"/><path d="m28 12 5 6-5 5-5-5Z" fill="#829e61"/><path d="M28 43v8m0-1-4 3m4-3 4 3" stroke="#cb8585" stroke-width="2" fill="none"/>',
    horse:'<path d="M12 23 9 3q12 1 13 19M34 22Q35 4 47 3l-3 20" fill="#bc926e"/>'+head('#d6ac84')+'<path d="M18 19Q20 3 39 11l-8 15-2-8-8 8Z" fill="#886850"/><ellipse cx="28" cy="42" rx="14" ry="10" fill="#f2d6b5"/><circle cx="22" cy="38" r="2" fill="#a78467"/><circle cx="34" cy="38" r="2" fill="#a78467"/>',
    sheep:ears('#bcaa8d')+'<path d="M8 28C-2 19 7 6 16 10 19-1 35-1 40 10 53 6 59 21 48 28Z" fill="#e7e2d4"/>'+head('#f4eedf')+'<path d="M9 24c-5-14 10-18 13-9 3-12 18-12 19 1 8-6 15 3 6 10" fill="#fffaf0"/>',
    monkey:ears('#b78e6f')+'<circle cx="10" cy="16" r="5" fill="#edd3b3"/><circle cx="46" cy="16" r="5" fill="#edd3b3"/>'+head('#b78e6f')+'<path d="M7 32C7 14 23 15 28 23c5-8 21-9 21 9 0 25-42 25-42 0" fill="#f0d8b7"/>',
    rooster:'<path d="M19 18C7 1 24-2 27 9 31-7 43 2 36 15Z" fill="#cf7870"/>'+head('#f8ead0')+'<path d="m3 24 9-4v10m41-6-9-4v10" fill="#e7bc72"/><ellipse cx="28" cy="47" rx="6" ry="7" fill="#cf7870"/><path d="m28 33 7 5-7 6-7-6Z" fill="#dba64e"/>',
    dog:head('#e8caa3')+'<path d="M15 14C-1 8-1 23 5 39q9 7 11-25M41 14C57 8 57 23 51 39q-9 7-10-25" fill="#ae8464"/><ellipse cx="28" cy="40" rx="11" ry="9" fill="#fff0d9"/><path d="M23 34q5-3 10 0-1 7-5 7t-5-7" fill="#735d50"/>',
    pig:'<path d="M8 25 4 5q17-1 19 18M33 23Q35 4 52 5l-4 20" fill="#d798a3"/>'+head('#efc1c6')+'<ellipse cx="28" cy="38" rx="11" ry="8" fill="#da9aa8"/><circle cx="24" cy="36" r="2" fill="#a3697a"/><circle cx="32" cy="36" r="2" fill="#a3697a"/>'
  });
