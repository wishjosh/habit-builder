const CACHE='habit-builder-v1.1.2';
const FILES=['./','./index.html','./style.css?v=0.2.1','./app.js','./engine.js','./storage.js','./cloud.js','./ui.js','./hierarchy.js','./manifest.webmanifest','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
