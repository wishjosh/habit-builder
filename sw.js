const CACHE='habit-builder-v1.3.0';
const FILES=['./','./index.html','./style.css?v=0.4.0','./app.js','./engine.js','./storage.js','./cloud.js','./ui.js','./hierarchy.js','./planner-ui.js','./manifest.webmanifest','./assets/icon.svg','./assets/icon-192.png','./assets/icon-512.png','./assets/apple-touch-icon.png'];
